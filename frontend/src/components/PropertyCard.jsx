  ...
  return (
    ...
    >
      <Link to={`/properties/${p._id}`} className="block">
        ...
        <div className="p-5">
          <h3 className="font-display text-xl mb-1 line-clamp-1 group-hover:text-gold transition">{p.title}</h3>
          ...
          <div className="flex items-center justify-between text-xs text-white/70 border-y border-white/10 py-3">
            <span className="flex items-center gap-1.5"><LuBed className="text-gold" />{p.bedrooms} Beds</span>
            <span className="flex items-center gap-1.5"><LuBath className="text-gold" />{p.bathrooms} Baths</span>
            <span className="flex items-center gap-1.5"><LuRuler className="text-gold" />{p.area} ft²</span>
          </div>
          <div className="flex items-end justify-between mt-4">
            ...
            <span className="btn-ghost !py-1.5 !px-4 text-xs"><FiHome /> View</span>
          </div>
        </div>
      </Link>
    </motion.div>
